...
public class Chapter06BiPredicateExample {

    // BiPredicate used to perform the below 2 predicate function
    private BiPredicate<Double,Integer> biPredicate = (gpa,gradeLevel)-> gpa <=3.9 && gradeLevel <=3 ;
    ...
    public static void main(String[] args) {
        new Chapter06BiPredicateExample().printStudentsWithGoodGrades(StudentDataBase.getAllStudents());
    }
}
